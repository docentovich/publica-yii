...
class m170610_023038_auth_item extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addPrimaryKey('pk_on_tbl_auth_item','{{%auth_item}}',['name']);

    }

    public function safeDown()
    {
    $this->dropPrimaryKey('pk_on_tbl_auth_item','{{%auth_item}}');
