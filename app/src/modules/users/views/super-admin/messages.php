    ...
    <div class="content">
      <div class="control-panel people-panel">
        <div class="control-panel-title">
          <div class="dark-icon dark-icon--control-panel"><i class="fa fa-envelope"></i></div><span>Посты</span>
        </div>
        <table>
          <colgroup span="4">
            <col width="55%"/>
          ...
          <tbody>
            ...
            <tr>
              <td><a href="/single-item/message.html">
                  <div class="dark-icon-wrapper icon-ban icon-wrapper">
                    <div class="dark-icon"><i class="far fa-envelope"></i></div>
            ...
            <tr>
              <td><a href="/single-item/message.html">
                  <div class="dark-icon-wrapper icon-approve icon-wrapper">
                    <div class="dark-icon"><i class="far fa-envelope"></i></div>
                  </div><span>Вася петров</span></a></td>
              <td>
                <label class="styled-checkbox approve select-item" rel="approve">
            ...
            <tr>
              <td><a href="/single-item/message.html">
                  <div class="dark-icon-wrapper icon-moderation icon-wrapper">
                    <div class="dark-icon"><i class="far fa-envelope"></i></div>
                  </div><span>Вася петров</span></a></td>
              <td>
                <label class="styled-checkbox approve select-item" rel="approve">
