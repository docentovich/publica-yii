      ...
      <div class="single-item">
        <div class="single-item-header">
          <div class="single-item-avatar-name">
            <div class="user-avatar dark-icon"><i class="far fa-edit"></i></div>
            <div class="single-item-title-name">
              <div class="single-item-title">Название 1</div>
              <div class="single-item-name">
                <div class="dark-icon"><i class="fa fa-user"></i></div>Вася петров
              </div>
            </div>
          </div>
