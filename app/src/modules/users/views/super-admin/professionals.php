...
<html>
  ...
  <body class="pageload">
    <header>
      <div id="header-inner">
        ...
        <div class="action-panel" id="drop-down-services"><a class="drop-down-service" href="http://publica.shablonkin.shn-host.ru/">
            ...
            <div class="drop-down-service-description">События</div></a><a class="drop-down-service" href="http://probank.shablonkin.shn-host.ru/">
    ...
    <div class="overlay overlay--super-admin-panel" id="service-menu-overlay">
      <div class="service-overlay-wrapper">
        <div class="super-admin-menu">
          <div class="super-admin-menu-header">
            <div class="user-avatar dark-icon"><i class="fa fa-user"></i></div>
            <div class="super-admin-role-name">
              <div class="super-admin-role"><i class="icon-crown"></i><span>Директор</span></div>
              <div class="super-admin-name">Вася петров</div>
            </div>
          </div>
          <div class="super-admin-menu-body">
            <ul>
              <li><a href="/">
                  <div class="dark-icon-wrapper">
                    <div class="dark-icon dark-icon--super-admin-menu"><i class="fa fa-user"></i></div>
                  </div><span>Люди</span></a></li>
              <li><a href="/posts.html">
                  <div class="dark-icon-wrapper">
                    <div class="dark-icon dark-icon--super-admin-menu"><i class="fa fa-edit"></i></div>
                  </div><span>Контент</span></a></li>
              <li><a href="/professionals.html">
                  <div class="dark-icon-wrapper">
                    <div class="dark-icon dark-icon--super-admin-menu"><i class="fa fa-briefcase"></i></div>
                  </div><span>Профессионалы</span></a></li>
              <li><a href="/messages.html">
                  <div class="dark-icon-wrapper">
                    <div class="dark-icon dark-icon--super-admin-menu"><i class="fa fa-envelope"></i></div>
                  </div><span>Письма директору</span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="content">
      <div class="control-panel people-panel">
        <div class="control-panel-title">
          <div class="dark-icon dark-icon--control-panel"><i class="fa fa-briefcase"></i></div><span>Профессионалы</span>
        </div>
        <table>
          <colgroup span="4">
            <col width="55%"/>
          ...
          <tbody>
            <tr class="line-1">
              <td>
                <div class="controls controls--professionals">
                  <button class="control-button--post">P</button>
                  <button class="control-button--model">М</button>
                  <button class="control-button--photo">Ф</button>
                </div>
              </td>
              <td>
                <label class="styled-checkbox select-all" id="approve-all" rel="approve">
                  <input type="checkbox"/><span></span>
                </label>
              </td>
              <td>
                <label class="styled-checkbox select-all" id="ban-all" rel="ban">
                  <input type="checkbox"/><span></span>
                </label>
              </td>
              <td>
                <label class="styled-checkbox select-all" id="message-all" rel="message">
                  <input type="checkbox"/><span></span>
                </label>
              </td>
            </tr>
            <tr>
              <td><a href="/single-item/photograph.html">
                  <div class="dark-icon-wrapper icon-photograph icon-wrapper">
                    <div class="dark-icon"><i class="fas fa-briefcase"></i></div>
                  </div><span>Вася петров</span></a></td>
              <td>
                <label class="styled-checkbox approve select-item" rel="approve">
                  <input type="checkbox"/><span></span>
                </label>
              </td>
              <td>
                <label class="styled-checkbox ban select-item" rel="ban">
                  <input type="checkbox"/><span></span>
                </label>
              </td>
              <td>
                <label class="styled-checkbox message select-item" rel="message">
                  <input type="checkbox"/><span></span>
                </label>
              </td>
            </tr>
            ...
            <tr>
              <td><a href="/single-item/model.html">
                  <div class="dark-icon-wrapper icon-model icon-wrapper">
                    <div class="dark-icon"><i class="fas fa-briefcase"></i></div>
                  </div><span>Вася петров</span></a></td>
              <td>
                <label class="styled-checkbox approve select-item" rel="approve">
            ...
            <tr>
              <td><a href="/single-item/journalist.html">
                  <div class="dark-icon-wrapper icon-journalist icon-wrapper">
                    <div class="dark-icon"><i class="fas fa-briefcase"></i></div>
                  </div><span>Вася петров</span></a></td>
              <td>
                <label class="styled-checkbox approve select-item" rel="approve">
