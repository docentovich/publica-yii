    ...
    <div class="content">
      <div class="control-panel people-panel">
        <div class="control-panel-header">
          <div class="dark-icon dark-icon--control-panel"><i class="fa fa-user"></i></div><span>Люди</span>
        </div>
        <table>
          <colgroup span="4">
            <col/>
          ...
          <tbody>
            ...
            <tr>
              <td><a href="/single-item/person.html">
                  <div class="dark-icon-wrapper icon-wrapper">
                    <div class="dark-icon"><i class="fa fa-user"></i></div>
