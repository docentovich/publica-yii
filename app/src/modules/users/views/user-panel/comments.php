...
<html>
  ...
  <body class="pageload">
    ...
    <div class="content">
      <div class="comments">
        <div class="comment">
          <div class="avatar"><img src="/images/avatars/6.jpg"/></div>
          <div class="text"><span class="name">Давно</span> выяснено, что при оценке дизайна и композиции читаемый</div>
        </div>
        <div class="comment">
          <div class="avatar"><img src="/images/avatars/2.jpg"/></div>
          <div class="text"><span class="name">Давно</span> выяснено, что при оценке дизайна и композиции читаемый</div>
        </div>
        <div class="comment">
          <div class="avatar"><img src="/images/avatars/5.jpg"/></div>
          <div class="text"><span class="name">Давно</span> выяснено, что при оценке дизайна и композиции читаемый</div>
        </div>
      </div>
    </div>
