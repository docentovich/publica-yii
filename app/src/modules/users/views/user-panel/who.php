  ...
  <body class="pageload">
    <header>
      <div id="header-inner">
        ...
        <div class="action-panel" id="drop-down-services"><a class="drop-down-service" href="http://tosee.shablonkin.shn-host.ru/">
    ...
    <div class="content">
      <div class="who">
        ...
        <div class="who-stay-simple"><a class="stay-simple-text" href="#">Остаться<br/>обычным серым<br/>пользователем</a><span class="stay-simple-or">или...</span></div>
        <div class="who-can-be">
          <div class="who-become">Стать</div>
          <div class="who-can-be-item">
            <div class="who-can-be-title"><a href="/roles/journalist.html">Журналистом</a></div>
            <div class="who-can-be-description">Может писать статьи</div>
          </div>
          <div class="who-can-be-item">
            <div class="who-can-be-title"><a href="/roles/photographer.html">Фотографом</a></div>
            <div class="who-can-be-description">Давно выяснено, что при оценке дизайна и композиции читаемый текст мешает сосредоточиться. Lorem Ipsum используют потому, что тот обеспечивает более или менее стандартное заполнение шаблона.</div>
          </div>
          <div class="who-can-be-item">
            <div class="who-can-be-title"><a href="/roles/model.html">Моделью</a></div>
            <div class="who-can-be-description">Давно выяснено, что при оценке дизайна и композиции читаемый текст мешает сосредоточиться.</div>
          </div>
        </div>
      </div>
    </div>
