<?php
use app\modules\tosee\widgets\sidebar\Sidebar;

echo \app\widgets\header\Header::widget(); //верхняя плашечка. она едина для всех частейы
?>
<!-- header1 -->
<div class="header1">
                ...
                <div class="header1__controls1">
                    ...
                    <div class="controls1">
                        ...
                        <div rel="search" class="controls1__conrol1 sidebar-open">
                            <div class="controls1__img-wrapper ">
<!--                                <object preserveAspectRatio="xMinYMin none" data="--><?php//= $bundle->baseUrl; ?><!--/images/svg/zoom1.svg"-->
